...
left_string_result = find_index_num_as_word_left(important_string)
right_string_result = find_index_num_as_word_right(important_string)
string_results = [left_string_result,right_string_result]
char_results = smallest_biggest_num_as_char(important_string)
print(get_left_right(string_results, char_results, important_string))